...
SELECT 'ALL','indexserver.ini','authentication','last_successful_connect_update_interval',' ','300','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.149,1,1,'2460123','CPU;lock_manager',' ' from DUMMY UNION ALL
...
SELECT 'ALL','indexserver.ini','calcengine','instantiate_max_itab_transformation_size',' ','<number_higher_than_number_of_predicates>','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.099,1,1,'2476064','calc_view',' ' from DUMMY UNION ALL
...
SELECT 'SYSREP','indexserver.ini','row_engine','keep_shared_memory_over_restart',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.119,1,1,'2522580','indexserver_crash; system_replication;RowStore;delta_data_shipping;takeover',' ' from DUMMY UNION ALL
...
SELECT 'ALL','indexserver.ini','calcengine','disabled_patterns',' ','23','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.109,1,1,'2557609','calc_view;calc_engine',' ' from DUMMY UNION ALL
...
SELECT 'ALL','indexserver.ini','calcengine','ce2qo_skip_cache_lookup',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.089,1,1,'2573582','calc_view;calc_engine',' ' from DUMMY UNION ALL
...
SELECT 'ALL','indexserver.ini','calcengine','disabled_patterns',' ','15','-- no recommendation --','-- no recommendation --','-- no recommendation --',122.06,122.069,1,1,'2583936','calc_view;calc_engine;performance',' ' from DUMMY UNION ALL
SELECT 'BW','indexserver.ini','calcengine','disabled_patterns',' ','43','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.149,1,1,'2584492','JDBC;Composite_Provider;calc_engine;OLAP_engine;BWoH',' ' from DUMMY UNION ALL
...
SELECT 'ALL','indexserver.ini','sql','calc_view_with_dyn_ap_unfold',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2441054','calc_view',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','calcengine','ce2qo_transient_plan_for_data_var',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2441054','calc_view',' ' from DUMMY UNION ALL
SELECT 'ALL','global.ini','communication','ssl',' ','off','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.129,1,1,'2547142','OOM;SSL;encryption',' ' from DUMMY UNION ALL
...
SELECT 'ALL','indexserver.ini','joins','single_thread_execution_for_partitioned_tables',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.169,1,1,'2620310','join_engine;performance;delta_merge',' ' from DUMMY UNION ALL
...
SELECT 'ALL','global.ini','memorymanager','enable_sharing_allocator_for_implicit',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',122.16,122.169,1,1,'2628153','OOM;memory_leak',' ' from DUMMY UNION ALL
...
SELECT 'ALL','indexserver.ini','performance_analyzer','planviz_enable',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.169,1,1,'2637828','memory_leak;performance;planviz;trace',' ' from DUMMY UNION ALL
SELECT 'MULTI','indexserver.ini','table_redist','balance_by_partnum',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'1958216','scale-out;redistribution;partitioning;performance',' ' from DUMMY UNION ALL
SELECT 'MULTI','indexserver.ini','table_redist','balance_by_memuse',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'1958216','scale-out;redistribution;partitioning;performance',' ' from DUMMY UNION ALL
SELECT 'MULTI','indexserver.ini','table_redist','balance_by_table_size_hosted',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'1958216','scale-out;redistribution;partitioning;performance',' ' from DUMMY UNION ALL
SELECT 'MULTI','indexserver.ini','table_redist','balance_by_rows',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'1958216','scale-out;redistribution;partitioning;performance',' ' from DUMMY UNION ALL
SELECT 'MULTI','indexserver.ini','table_redist','balance_by_part_id',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'1958216','scale-out;redistribution;partitioning;performance',' ' from DUMMY UNION ALL
SELECT 'MULTI','indexserver.ini','table_redist','balance_by_execution_time',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'1958216','scale-out;redistribution;partitioning;performance',' ' from DUMMY UNION ALL
SELECT 'MULTI','indexserver.ini','table_redist','balance_by_execution_count',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'1958216','scale-out;redistribution;partitioning;performance',' ' from DUMMY UNION ALL
SELECT 'MULTI','indexserver.ini','table_redist','balance_by_table_classification',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'1958216','scale-out;redistribution;partitioning;performance',' ' from DUMMY UNION ALL
SELECT 'MULTI','indexserver.ini','table_redist','balance_by_table_subclassification',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'1958216','scale-out;redistribution;partitioning;performance',' ' from DUMMY UNION ALL
...
SELECT 'ALL','indexserver.ini','sql','native_mixed_join_enabled',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.169,1,1,'2624305','memory_leak;memory_management;OOM;join_engine;inverted_index',' ' from DUMMY UNION ALL
SELECT 'ALL','global.ini','performance_analyzer','plan_trace_enable',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2643064','indexserver_crash;trace;planviz;signal_11',' ' from DUMMY UNION ALL
SELECT 'ALL','global.ini','persistence','non_trans_cch_block_size',' ','134217728','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'1999998','parameter;delta_merge',' ' from DUMMY UNION ALL
SELECT 'SYSREP','nameserver.ini','sld','enable',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.129,1,1,'2577511','SLD;system_replication',' ' from DUMMY UNION ALL
SELECT 'ALL','nameserver.ini','sld','enable',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.129,1,1,'2577511','SLD;MDC',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','performance_analyzer','planviz_enable',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2600030','indexserver_crash;planviz',' ' from DUMMY UNION ALL
SELECT 'ALL','xsengine.ini','httpserver','sessiontimeout',' ','<new_value>','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2473231','XS_engine;session;tcp_timeout;connection_limit',' ' from DUMMY UNION ALL
SELECT 'ALL','xsengine.ini','httpserver','maxsessions',' ','<new_value>','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2473231','XS_engine;session;tcp_timeout;connection_limit',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','transaction','lock_wait_timeout',' ','5*<timeout_in_ms>','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2549013','lock_manager;deadlock',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','sql','cs_equi_cond_update_optimization_batch_size',' ','1000000','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2644935','LOB;wrong_result;consistency',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','persistence','use_helper_threads_for_flush',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',122.16,-1,1,1,'2655238','XFS;volume;performance',' ' from DUMMY UNION ALL
SELECT 'ALL','nameserver.ini','statisticsserver','active',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2644242','statisticsserver;system_view;upgrade',' ' from DUMMY UNION ALL
SELECT 'ALL','indexserver.ini','statisticsserver','threadpool',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.149,1,1,'2584388','Memory_leak;',' ' from DUMMY UNION ALL
SELECT 'ALL','global.ini','backup','data_backup_buffer_size',' ','1536','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2657261','backup;backint;performance',' ' from DUMMY UNION ALL
SELECT 'ALL','global.ini','backup','parallel_data_backup_backint_channels',' ','3','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2657261','backup;backint;performance',' ' from DUMMY UNION ALL
SELECT 'SYSREP','global.ini','system_replication','check_secondary_active_status',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2649721','system_replication;lock_manager;system_view',' ' from DUMMY UNION ALL
