...
SELECT 3,'SDA','indexserver.ini','smart_data_access','enable_binary_transfer',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.089,1,1,'2472882','virtual_table;LOB;SDA',' ' from DUMMY UNION ALL
...
SELECT 3,'SDI','dpserver.ini','persistence','receiver_comi_interval_sec',' ','2','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.139,1,1,'2560056','SDI;data_provisioning',' ' from DUMMY UNION ALL
...
SELECT 2,'ALL','global.ini','expensive_statement','use_in_memory_tracing',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.199,1,1,'2608324','trace;',' ' from DUMMY UNION ALL
...
SELECT 2,'ALL','indexserver.ini','session','fda_enable',' ','off','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.179,1,1,'2627679','FDA;workprocess;signal_11',' ' from DUMMY UNION ALL
...
SELECT 2,'ALL','indexserver.ini','sql','native_mixed_join_enabled',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.169,1,1,'2624305','memory_leak;memory_manager;OOM;join_engine;inverted_index',' ' from DUMMY UNION ALL
SELECT 2,'ALL','global.ini','performance_analyzer','plan_trace_enable',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.179,1,1,'2643064','indexserver_crash;trace;planviz;signal_11',' ' from DUMMY UNION ALL
...
SELECT 1,'ALL','indexserver.ini','performance_analyzer','planviz_enable',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.179,1,1,'2600030','indexserver_crash;planviz',' ' from DUMMY UNION ALL
...
SELECT 2,'ALL','indexserver.ini','transaction','lock_wait_timeout',' ','5*<timeout_in_ms>','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.189,1,1,'2549013','lock_manager;deadlock;XS_engine',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sql','cs_equi_cond_update_optimization_batch_size',' ','1000000','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.179,1,1,'2644935','LOB;wrong_result;consistency',' ' from DUMMY UNION ALL
SELECT 3,'ALL','indexserver.ini','persistence','use_helper_threads_for_flush',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',122.16,122.179,1,1,'2655238','XFS;volume;performance',' ' from DUMMY UNION ALL
...
SELECT 2,'ALL','indexserver.ini','statisticsserver','threadpool',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.189,1,1,'2584388','Memory_leak;',' ' from DUMMY UNION ALL
...
SELECT 3,'SYSREP','global.ini','system_replication','check_secondary_active_status',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.179,1,1,'2649721','system_replication;lock_manager;system_view',' ' from DUMMY UNION ALL
...
SELECT 2,'ALL','indexserver.ini','joins','disable_pruning',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',122.09,122.199,1,1,'2666574','wrong_result;join_engine;partitioning;ESH',' ' from DUMMY UNION ALL
SELECT 3,'ALL','global.ini','resource_tracking','service_thread_sampling_monitor_enabled',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.139,1,1,'2672038','memory_leak;memory_manager;',' ' from DUMMY UNION ALL
SELECT 3,'ALL','global.ini','resource_tracking','service_thread_sampling_monitor_thread_detail_enabled',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.139,1,1,'2672038','memory_leak;memory_manager;',' ' from DUMMY UNION ALL
SELECT 1,'ALL','global.ini','persistence','recovery_max_load_parallelity',' ','8','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.209,1,1,'2668174','log_segments',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','transaction','global_deadlock_check_timeout_on_lock_waiting',' ','<timeout_in_ms>','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.189,1,1,'2549013','lock_manager;deadlock;XS_engine',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','row_engine','num_of_freepage_distributor',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.149,1,1,'2577314','PowerPC;RowStore;consistency',' ' from DUMMY UNION ALL
SELECT 2,'ALL','global.ini','communication','ssl',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',122.14,122.149,1,1,'2584253','SSL;encryption',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','table_placement','max_partitions',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2600030','BWoH;2TB;redistribution;scale-out',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','table_placement','max_partitions_limited_by_locations',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2600030','BWoH;2TB;redistribution;scale-out',' ' from DUMMY UNION ALL
SELECT 2,'BW','indexserver.ini','calcengine','disabled_patterns',' ','47','-- no recommendation --','-- no recommendation --','-- no recommendation --',122.15,122.159,1,1,'2605359','BEx;calc_view;calc_engine;BWoH',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','sqlscript','enable_internal_statement_caching',' ','no','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.149,1,1,'2587007','wrong_result;result_cache;SQLScript;TUDF;calc_view',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','persistence','optimized_rowstore_load',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2612205','OOM;Rowstore',' ' from DUMMY UNION ALL
SELECT 2,'ALL','global.ini','persistence','internal_caching_for_main',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',122.06,122.169,1,1,'2600030','memory_leak;page_cache',' ' from DUMMY UNION ALL
SELECT 2,'ALL','daemon.ini','daemon','terminationtimeout',' ','600000','-- no recommendation --','-- no recommendation --','-- no recommendation --',122.16,122.169,1,1,'2633077','LOB;GC;',' ' from DUMMY UNION ALL
SELECT 1,'SDA','indexserver.ini','smart_data_access','odbc_adapters_in_scriptserver',' ','mssql','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2348834','indexserver_crash;SDA',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','persistence','disposition_lob_read',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',122.16,122.169,1,1,'2633077','LOB;GC;',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','persistence','disposition_lob_read_small',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',122.16,122.169,1,1,'2633077','LOB;GC;',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','persistence','disposition_lob_write',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',122.16,122.169,1,1,'2633077','LOB;GC;',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','persistence','disposition_lob_write_small',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',122.16,122.169,1,1,'2633077','LOB;GC;',' ' from DUMMY UNION ALL
SELECT 4,'ALL','indexserver.ini','sqltrace','filesize_limit',' ','2147483648','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.169,1,1,'2629103','trace;',' ' from DUMMY UNION ALL
SELECT 4,'ALL','indexserver.ini','sqltrace','max_files',' ','10','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.169,1,1,'2629103','trace;',' ' from DUMMY UNION ALL
SELECT 2,'ALL','global.ini','executed_statement','enable_ddl',' ','off','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.169,1,1,'2627000','migration;',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','session','data_format_version',' ','6','7','-- no recommendation --','-- no recommendation --',120,122.179,1,1,'2638379','HANA_client;JDBC;SQLDBC',' ' from DUMMY UNION ALL
SELECT 2,'MULTI','indexserver.ini','transaction','global_deadlock_check_timeout_on_lock_waiting',' ','<timeout_in_ms>','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.189,1,1,'2549013','scale-out;lock_manager;deadlock',' ' from DUMMY UNION ALL
SELECT 2,'MULTI','indexserver.ini','transaction','lock_wait_timeout',' ','5*<timeout_in_ms>','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.189,1,1,'2549013','scale-out;lock_manager;deadlock',' ' from DUMMY UNION ALL
SELECT 1,'MULTI','indexserver.ini','search','late_materialization_threshold',' ','-1','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.179,1,1,'2662717','indexserver_crash;scale-out',' ' from DUMMY UNION ALL
SELECT 3,'ALL','indexserver.ini','session','data_format_version',' ','8','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2639764','SQL_round;wrong_result',' ' from DUMMY UNION ALL
SELECT 3,'MULTI','indexserver.ini','mds','mds_distributed_cache_timeout_ms',' ','2000','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2598662','MDS;performance;scale-out;',' ' from DUMMY UNION ALL
SELECT 3,'ALL','indexserver.ini','calcengine','ce2qo_disable_unfolding',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.129,1,1,'2222200','network;calc_engine;calc_view',' ' from DUMMY UNION ALL
SELECT 2,'MULTI','global.ini','memorymanager','enable_sharing_allocator_for_implicit ',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',122.18,-1,1,1,'2669798','OOM;workload_management;scale-out',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','transaction','aggressive_gc_interval',' ','300','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2000002','performance;GC;system_view',' ' from DUMMY UNION ALL
SELECT 2,'ALL','global.ini','memoryobjects','unused_retention_period',' ','0','3600','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2600030','performance;unload;memory_management',' ' from DUMMY UNION ALL
SELECT 2,'BW','indexserver.ini','session','idle_connection_timeout',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2621464','tcp_timeout;BWoH;error_10107;error_10108;network',' ' from DUMMY UNION ALL
SELECT 4,'ALL','global.ini','resource_tracking','service_thread_sampling_monitor_thread_detail_enabled',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2524020','trace;consistency',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','global','pa_count_distinct_threshold',' ','4096','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.179,1,1,'2632776','Data_aging;memory_leak',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','indexing','enable_lazy_row_locks',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.189,1,1,'2665390','lock_manager;',' ' from DUMMY UNION ALL
SELECT 3,'SDI','indexserver.ini','dataprovisioning','applierRetryUniqueConstraintViolationWithUpsert',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.199,1,1,'2679343','SDI;flowgraph;data_provisioning',' ' from DUMMY UNION ALL
SELECT 1,'ALL','global.ini','backup','max_log_backup_group_size',' ','1','-- no recommendation --','-- no recommendation --','-- no recommendation --',122.15,122.209,1,1,'2682426','backint;backup',' ' from DUMMY UNION ALL
SELECT 1,'ALL','global.ini','backup','backint_response_timeout',' ','10','30','-- no recommendation --','-- no recommendation --',122.15,122.209,1,1,'2682426','backint;backup',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','resource_tracking','service_thread_sampling_monitor_thread_detail_enabled',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.069,1,1,'2670614','memory_leak;memory_manager;',' ' from DUMMY UNION ALL
SELECT 1,'BW','indexserver.ini','query_mediator','cache_enable',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.199,1,1,'2686900','indexserver_crash;attribute_engine;BWoH;SCM;Cube',' ' from DUMMY UNION ALL
SELECT 4,'ALL','indexserver.ini','trace','sqlsession',' ','fatal','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.199,1,1,'2666338','SSL;encryption;session;trace;SQLDBC',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','joins','trace_inputs_of_failed_pop',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.199,1,1,'2673798','indexserver_crash;Join_engine;optimizer',' ' from DUMMY UNION ALL
SELECT 1,'MULTI','indexserver.ini','distribution','client_distribution_mode',' ','off','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.199,1,1,'2686498','wrong_result;scale-out',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','calcengine','disabled_patterns',' ','6','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.179,1,1,'2683989','wrong_result;calc_view',' ' from DUMMY UNION ALL
SELECT 2,'SYSREP','global.ini','system_replication','enable_ssl',' ','off','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.129,1,1,'2688216','SSL;system_replication;encryption',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','businessDB','strict_rounding_for_emu_conversion',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.199,1,1,'2679900','wrong_result;SQL_Round;Currency_Conversion',' ' from DUMMY UNION ALL
...
SELECT 3,'SDI','dpserver.ini','framework','useStreaming',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',122.17,-1,1,1,'2673170','SDI;data_provisioning',' ' from DUMMY UNION ALL
SELECT 2,'ALL','indexserver.ini','sql','enable_general_like_predicate_cv_unfolding',' ','true','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.199,1,1,'2675483','calc_engine;calc_view;',' ' from DUMMY UNION ALL
SELECT 3,'ALL','indexserver.ini','query_mediator','local_group_bys_max_table_sets_per_host',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2704926','indexes;OLAP',' ' from DUMMY UNION ALL
SELECT 1,'ALL','global.ini','trace','stream',' ','fatal','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.209,1,1,'2709843','indexserver_crash;signal_11;network',' ' from DUMMY UNION ALL
SELECT 1,'ALL','indexserver.ini','indexing','use_tu_query_cache',' ','false','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.049,1,1,'2710308','indexserver_crash;',' ' from DUMMY UNION ALL
SELECT 2,'SDI','indexserver.ini','dataprovisioning','appliermaxrowsstagingtable',' ','0','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2710286','SDI;data_provisioning;flowgraph;performance',' ' from DUMMY UNION ALL
SELECT 2,'SDI','dpserver.ini','persistence','distributor_commit_interval_sec',' ','300','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2710286','SDI;data_provisioning;flowgraph;performance',' ' from DUMMY UNION ALL
SELECT 2,'SDI','dpserver.ini','persistence','receiver_commit_interval_sec',' ','2','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2710286','SDI;data_provisioning;flowgraph;performance',' ' from DUMMY UNION ALL
