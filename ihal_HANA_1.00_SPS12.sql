...
SELECT 'ALL','indexserver.ini','calcengine','disable_patterns',' ','23','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.109,1,1,'2557609','calculation_view;calc_engine',' ' from DUMMY UNION ALL
...
SELECT 'SDI','dpserver.ini','persistency','receiver_comi_interval_sec',' ','2','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.139,1,1,'2560056','SDI',' ' from DUMMY UNION ALL
...
SELECT 'ALL','global.ini','backup','parallel_data_backup_backint_channels',' ','-- no recommendation --','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,-1,1,1,'2579371','indexserver_crash;nameserver_crash;backup,backint',' ' from DUMMY UNION ALL
...
SELECT 'ALL','indexserver.ini','calcengine','disable_patterns',' ','15','-- no recommendation --','-- no recommendation --','-- no recommendation --',122.06,122.069,1,1,'2583936','calculation_view;calc_engine;performance',' ' from DUMMY UNION ALL
...
SELECT 'BW','indexserver.ini','calcengine','disable_patterns',' ','38','-- no recommendation --','-- no recommendation --','-- no recommendation --',120,122.129,1,1,'2100040','BWoH;CPU;performance',' ' from DUMMY UNION ALL
